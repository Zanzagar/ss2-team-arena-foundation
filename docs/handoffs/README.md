...
| --- | --- | --- |
| [2026-09-01 17:33 — the armoured family measured, and the schema question](2026-09-01-1733--armoured-family-measured-and-the-schema-question.md) | `6c06a03b` | Supersedes 2026-09-01-1550 and retracts its ranked items 1 and 3 by measurement. An arming gate keyed on the fixtures would have armed 0 of 38 and its hero predicate contradicts all 8; but 35 of 38 archived rounds reproduce everything except `staminaleft`, and `hero.staminaleft == 110 − walks` holds 38/38. The chosen villain-stamina remedy was derived and NOT applied: `COMBATANT_KEYS` pins the output and refuses the input, and a value-only edit goes green even at an impossible value. Archive made verifiable and the D: mirror brought current. Two waves VERIFIED, 16 of 36 verdicts BROKEN |
