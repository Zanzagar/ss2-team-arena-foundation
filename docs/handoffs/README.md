...
| --- | --- | --- |
| [2026-09-01 16:37 — the armoured family measured at n=38](2026-09-01-1637--armoured-family-measured-at-n38.md) | `6c06a03b` | Supersedes 2026-09-01-1550 and RETRACTS its ranked item 1 by measurement: an arming gate keyed on the fixtures would have armed 0 of 38, and its hero predicate contradicts all 8 of them. But 35 of 38 archived rounds reproduce everything except `staminaleft`, and `hero.staminaleft == 110 − walks` holds 38/38; the villain's action sequence is unobserved by construction; 2 fixtures REFUSE at ingest for a missing watch field. Wave VERIFIED 6/6 + 18/18, 9 verdicts BROKEN |
